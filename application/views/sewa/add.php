<div class="row">
	<div class="panel panel-primary">
	    ...
	    <form id="sewa" method="post" action="<?php echo base_url('sewa/createSewa'); ?>">
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
		    	...
		    	<input type="text" class="form-control input-lg" name="tanggal" id="tanggal" required>
		    </div>
		  	<div class="form-group">
		    	<label for="selesai">Jam Booking</label>
		    	<input type="text" class="form-control input-lg" name="jambooking" id="jambooking" required>
		    </div>
		    <div class="form-group">
		  	...
		  	<div class="form-group">
		    	...
		    	<div class="input-group">
		    		...
		    		<input type="text" class="form-control input-lg" name="uangmuka" required>
		    	</div>
		    </div>
